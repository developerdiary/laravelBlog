            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        ...
                        <div class="col-sm-12 col-md-7">
                            <button class="btn btn-primary" @click="addPost"><span>Add</span></button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {    
    ...
    methods: {
        ...
        addPost(){
            ...
            _this.errors = [];
            _this.message = '';
            axios.post(this.$parent.MakeUrl('admin/post'), {'title': this.title, 'description': this.description, 'category_value': this.category_value, 'tag_value': this.tag_value}).then((res) => {
                _this.loading = false;
                //_this.resetForm();
